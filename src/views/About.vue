<template>
  <div class="about py-8 px-8">
    ...
    <h2 class="text-xl mb-2">Google Analyticsについてのプライバシーポリシー</h2>
    ...
    <p class="mb-4">
      Google Analyticsは、当サイトが発行するクッキー（Cookie）を利用して、個々のユーザーを識別する情報を含みます。ただし、これら情報には個人を特定する情報は含まれません。収集された情報はGoogle
      LLCのサーバーへ送信・保存されます。
    </p>

    <p class="mb-4">
      Google Analyticsの利用により収集されたデータはGoogle LLCのプライバシーポリシーに基づいて管理されます。Google Analyticsにより収集されたデータの利用に関する説明はGoogle
      LLCのウェブサイトで確認できます。
    </p>
    ...
    <p class="mb-4">
      Google Analyticsを使用しない設定については、以下のGoogle LLCが提供するページからGoogle Analytics Opt-out Browser
      Add-onをダウンロード・インストールすることでウェブブラウザから無効化することができます。
    </p>
